...
export default function AboutSection1() {
  ...
  const revealVariants2: Variants = {
    visible: (i: number) => ({
      y: 0,
      opacity: 1,
      filter: "blur(0px)",
  ...
  return (
    ...
    >
      ...
      <TimelineContent
        ...
        timelineRef={heroRef as React.RefObject<HTMLElement>}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-gray-900 mb-6">
          <VerticalCutReveal
            ...
            containerClassName="text-[#000000] leading-[120%] text-center justify-center items-center"
          >
        ...
        >
          From day one, our mission has been to create photographs that inspire,
          empower, and make a difference. With a commitment to quality and
          creativity, every session tells a unique story.
        </TimelineContent>
        ...
        >
          <a
            href="/book"
            className="bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-600/40 border border-blue-600 flex w-fit gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-white px-5 py-3 rounded-full cursor-pointer no-underline items-center"
          >
            Book a Session <ArrowRight className="w-4 h-4 mt-0.5" />
          </a>
        </TimelineContent>
      </div>
